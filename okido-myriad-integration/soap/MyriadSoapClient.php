...
if($function_name == "SOAP_createOrder" || $function_name == "SOAP_createCirculationOrder" || $function_name == "SOAP_reregisterCirculationOrder"){
                   $_SESSION['last_myriad_request'] = $wpdb->insert_id;
               }
            }
